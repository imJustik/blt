...
class Hud: SKNode {
    ...
    private func addScore() { //добавляем счет
        ...
        lblScore.fontSize = 40 * Controller.xScale
    ...
    func addScoreForMultiplay(){
        ...
        Hud.enemyScore.fontSize = 40 * Controller.xScale
    ...
    func addHealth(cnt: Int){
        ...
        for var i = 0; i<cnt; i++ {
            ...
            health[i].position = CGPoint(x: lblScore.position.x - CGFloat(firstXPosition) , y: lblScore.position.y - 10*Controller.yScale)
    ...
    func addHealthForMultiplay(cnt: Int){ //добавляет жизни врага в мультлее
        ...
        for var i = 0; i<cnt; i++ {
            ...
            enemyHealth[i].position = CGPoint(x:  Hud.enemyScore.position.x - CGFloat(firstXPosition) * Controller.xScale , y:  Hud.enemyScore.position.y - 10 * Controller.yScale)
